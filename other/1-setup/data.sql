INSERT INTO Fournisseur (nom, contact, etat) VALUES 
...
('Viennoiserie', 'Produits de boulangerie feuilletée'),
...
('Pain au Chocolat', 'Viennoiserie avec chocolat', 1.8, 1, 'pcs'),
('Baguette', 'Pain français classique', 0.9, 3, 'pcs');
...
(2, 3, 5.0),
(3, 4, 1.2);
INSERT INTO Produit_Format (nom, prix_unitaire, Id_Produit, Id_Format) VALUES 
...
('2025-01-01 10:00:00', 10.0, '2025-01-02 10:00:00', '123 Rue Principale', 1, 1),
('2025-01-05 12:00:00', 20.0, '2025-01-06 12:00:00', '456 Boulevard Sud', 1, 2);
INSERT INTO Vente_Facture (quantite, prix_unitaire, montant, Id_Produit_Format, Id_Vente) VALUES 
(5, 1.8, 9.0, 1, 1),
(6, 1.5, 9.0, 2, 1);
