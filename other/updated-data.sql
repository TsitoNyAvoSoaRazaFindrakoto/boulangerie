...
INSERT INTO employe (nom, prenoms, date_naissance, date_embauche, Id_Type_Employe)
VALUES 
  ('Dupont', 'Jean', '1980-05-15', '2000-01-01', 'VENDEUR'),
  ('Martin', 'Claire', '1975-08-22', '2005-06-10', 'MANAGER'),
  ('Durand', 'Paul', '1990-12-01', '2015-03-15', 'VENDEUR');

-- Corrected Vente Inserts
INSERT INTO vente (date_vente, montant, adresse_livraison, etat, Id_Employe, Id_Client)
VALUES 
  ('2025-01-21 10:00:00', 500.00, '123 Rue Principale', 1, 1, 1),
  ('2025-01-21 11:30:00', 750.00, '456 Avenue des Champs', 1, 3, 2),
  ('2025-01-21 14:15:00', 1200.00, '789 Boulevard Sud', 1, 1, 3);